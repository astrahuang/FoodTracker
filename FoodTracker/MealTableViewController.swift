...
//  FoodTracker
//
//  Created by Mac Pro on 2017/2/11.
...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // creates a special type of bar button item that has editing behavior built into it. It then adds this button to the left side of the navigation bar
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //  as? MealTableViewCell: downcast the type of the cell to  MealTableViewCell, returns an optional
    ...
    */
    ...
    // returns an optional array of Meal objects
